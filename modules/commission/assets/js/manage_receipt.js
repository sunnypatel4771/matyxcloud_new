...
function init_applicable_staff_table() {
  ...
  initDataTable(
    ".table-commission-receipt",
    admin_url + "commission/commission_receipt_table",
    false,
    false,
    fnServerParams,
    [0, "desc"],
...
function convert_expense(commission_receipt, total) {
  ...
  $("#commission_receipt_additional").append(
    hidden_input("commission_receipt_id", commission_receipt),
  );
}
