...
return App_table::find('clients')
    ...
    <label class="onoffswitch-label" for="' . $aRow['userid'] . '"></label>
        ...
        App_table_filter::new('cam_id', 'SelectRule')
            ...
            ->raw(function ($value) {
                return db_prefix() . 'clients.cam_id = ' . (int) $value;
            }),
        ...
        App_table_filter::new('optimizer_id', 'SelectRule')
            ...
            ->raw(function ($value) {
                return db_prefix() . 'clients.optimizer_id = ' . (int) $value;
            }),
        ...
        App_table_filter::new('organic_social_id', 'SelectRule')
            ...
            ->raw(function ($value) {
                return db_prefix() . 'clients.organic_social_id = ' . (int) $value;
            }),
        ...
        App_table_filter::new('seo_lead_id', 'SelectRule')
            ...
            ->raw(function ($value) {
                return db_prefix() . 'clients.seo_lead_id = ' . (int) $value;
            }),
        ...
        App_table_filter::new('sale_rep_id', 'SelectRule')
            ...
            ->raw(function ($value) {
                return db_prefix() . 'clients.sale_rep_id = ' . (int) $value;
            }),
        ...
        App_table_filter::new('content_id', 'SelectRule')
            ...
            ->raw(function ($value) {
                return db_prefix() . 'clients.content_id = ' . (int) $value;
            }),
        ...
        App_table_filter::new('web_lead_id', 'SelectRule')
            ...
            ->raw(function ($value) {
                return db_prefix() . 'clients.web_lead_id = ' . (int) $value;
            }),
