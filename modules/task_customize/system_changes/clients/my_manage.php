                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <?php echo render_select('cam_id', $staff, ['staffid', ['firstname', 'lastname']], 'cam_id'); ?>
                                            </div>
                                            <div class="col-md-12">

                                                <?php echo render_select('optimizer_id', $staff, ['staffid', ['firstname', 'lastname']], 'optimizer_id'); ?>
                                            </div>
                                            <div class="col-md-12">

                                                <?php echo render_select('organic_social_id', $staff, ['staffid', ['firstname', 'lastname']], 'organic_social_id'); ?>
                                            </div>
                                            <div class="col-md-12">

                                                <?php echo render_select('seo_lead_id', $staff, ['staffid', ['firstname',  'lastname']], 'seo_lead_id'); ?>
                                            </div>
                                            <div class="col-md-12">

                                                <?php echo render_select('sale_rep_id', $staff, ['staffid', ['firstname', 'lastname']], 'sale_rep_id'); ?>
                                            </div>
                                            <!-- Content -->
                                            <div class="col-md-12">

                                                <?php echo render_select('content_id', $staff, ['staffid', ['firstname', 'lastname']], 'content_id'); ?>

                                            </div>
                                            <!-- Web Lead -->
                                            <div class="col-md-12">

                                                <?php echo render_select('web_lead_id', $staff, ['staffid', ['firstname', 'lastname']], 'web_lead_id'); ?>
...
<script>
    ...
    function customers_bulk_action(event) {
        ...
        if (r == false) {
            ...
            data.ids = ids;
            data.cam_id = $('select[name="cam_id"]').val();
            data.optimizer_id = $('select[name="optimizer_id"]').val();
            data.organic_social_id = $('select[name="organic_social_id"]').val();
            data.seo_lead_id = $('select[name="seo_lead_id"]').val();
            data.sale_rep_id = $('select[name="sale_rep_id"]').val();
            data.content_id = $('select[name="content_id"]').val();
            data.web_lead_id = $('select[name="web_lead_id"]').val();
