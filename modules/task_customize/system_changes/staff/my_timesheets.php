                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <?php echo render_select('billable_filter', [
                                    ['id' => 'yes', 'name' => _l('yes')],
                                    ['id' => 'no', 'name' => _l('no')],
                                ], ['id', 'name']); ?>
                            </div>
                            ...
                            $task_type_option = $Ci->custom_fields_model->get(TASK_TYPE);

                            $task_type_options = [];

                            if ($task_type_option && $task_type_option->options) {
                                $options = explode(',', $task_type_option->options);
...
$(function() {
    ...
    Timesheets_ServerParams['billable_filter'] = 'select#billable_filter';

    Timesheets_ServerParams['custom_field_10_filter'] = 'select#custom_field_10_filter';
