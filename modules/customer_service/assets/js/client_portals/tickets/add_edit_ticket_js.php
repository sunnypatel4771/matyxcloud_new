	...
	$(function(){
		...
		$('select[name="client_id"]').on('change', function() {
			...
			if(client_id != '' && client_id != undefined){
				...
				$.post(site_url + 'customer_service/customer_service_client/get_invoice_by_client/'+client_id).done(function(response){
		...
		$('select[name="invoice_id"]').on('change', function() {
			...
			if(invoice_id != '' && invoice_id != undefined){
				...
				$.post(site_url + 'customer_service/customer_service_client/get_list_item_warranty_by_invoice/'+invoice_id).done(function(response){
					response = JSON.parse(response);
		...
		$('select[name="category_id"]').on('change', function() {
			...
			if(category_id != '' && category_id != undefined){
				...
				$.post(site_url + 'customer_service/customer_service_client/get_category_info/'+category_id).done(function(response){
					response = JSON.parse(response);
