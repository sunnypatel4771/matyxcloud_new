...
function init_editor(selector, settings) {
  ...
  var _settings = {
    ...
    toolbar: "codesample| code | fontfamily fontsize | forecolor backcolor | bold italic | alignleft aligncenter alignright alignjustify | image link | bullist numlist | restoredraft",
